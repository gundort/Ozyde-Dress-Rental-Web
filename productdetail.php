...
// Parse sizes from the size column (format: "S:10,M:5,L:8")
$sizes = [];
          ...
          <div class="product-info">
            ...
            <div class="size-section">
              <div class="size-header">
                <h3>Select Size</h3>
                <p class="size-note">Please note this item is ONLY available in the following sizes</p>
              </div>
              <div class="size-grid">
              ...
              <a href="sizingguide.html" class="size-guide-link">Size Guide</a>
            </div>
